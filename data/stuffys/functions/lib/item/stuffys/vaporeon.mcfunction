...
#Custom Lore
data modify storage lunaticol:temp_item Item.tag.display.Lore append value '{"text":"\'Its cell structure is similar","color":"gray"}'
data modify storage lunaticol:temp_item Item.tag.display.Lore append value '{"text":"to water molecules. It will","color":"gray"}'
data modify storage lunaticol:temp_item Item.tag.display.Lore append value '{"text":"melt away and become invisible in water.\'","color":"gray"}'
#AttributeModifiers
